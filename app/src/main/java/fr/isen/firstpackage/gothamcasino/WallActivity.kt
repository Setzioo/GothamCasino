            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    for (document in task.result!!) {
                        ...
                        tempArticleModel = ArticleModel(document.data["id"] as Long,document.data["userId"] as Long,document.data["title"] as String,document.data["description"] as String,document.data["photoUrl"] as String,document.data["nbLike"] as Long,document.data["nbDislike"] as Long)
